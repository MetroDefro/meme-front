                ...
                <Form.Floating>
                    ...
                    <div className={styles.persnalInputSection}>
                        <div class="form-floating mb-3">
                            <span>ID:</span>
                            <input type="text" className={styles.persnalInput} placeholder="닉네임" name="nickname" value={formData.nickname} onChange={handleInputChange} maxlength='8' />
                            <span>PW:</span>
                            <input type="password" className={styles.persnalInput} placeholder="비밀번호" name="password" value={formData.password} onChange={handleInputChange} maxlength='4' />
                        </div>
                    </div>
                    <div class="form-floating mb-3">
